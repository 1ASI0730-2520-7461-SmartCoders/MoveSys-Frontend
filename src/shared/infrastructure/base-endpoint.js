...
export class BaseEndpoint {
  ...
  search(query, params = {}) {
    return this.http.get(`${this.endpointPath}/search`, { 
      params: { q: query, ...params } 
    });
  }

  bulkCreate(resources) {
    return this.http.post(`${this.endpointPath}/bulk`, { resources });
  }

  bulkUpdate(resources) {
    return this.http.put(`${this.endpointPath}/bulk`, { resources });
  }

  bulkDelete(ids) {
    return this.http.delete(`${this.endpointPath}/bulk`, { 
      data: { ids } 
    });
  }
}
